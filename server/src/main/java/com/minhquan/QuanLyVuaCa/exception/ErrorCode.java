...
// ----------------
    ...
    NEW_PASSWORD_SAME_AS_OLD(1035, "Mat khau moi khong duoc trung mat khau hien tai", HttpStatus.BAD_REQUEST),
    ...
    RATE_LIMIT_EXCEEDED(1086, "Qua nhieu yeu cau, vui long thu lai sau", HttpStatus.TOO_MANY_REQUESTS);
