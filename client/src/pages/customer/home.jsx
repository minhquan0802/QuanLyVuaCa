                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                        ...
                        <div className="w-full md:w-96">
                            <div className="relative group">
                                ...
                                <input
                                    type="text"
                                    className="block w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 bg-white text-slate-800 placeholder:text-slate-400 focus:ring-2 focus:ring-cyan-500 focus:bg-white transition-all duration-300 ease-in-out"
