...
export default function AdminSidebar() {
    ...
    return (
        <aside className="w-64 bg-cyan-950 border-r border-cyan-900 flex flex-col h-screen fixed left-0 top-0 z-50 font-body text-cyan-300">
            <div className="h-20 flex items-center px-5 border-b border-cyan-900">
                <div className="flex items-center gap-3 cursor-pointer select-none">
                    <span className="font-display font-black text-lg leading-tight tracking-wide text-cyan-100 uppercase">
                        Vựa cá Điêu Hồng
                    </span>
                </div>
            </div>
